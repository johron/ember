#pragma once
#include "icon_font_engine.h"
#include "icon_font_factory.h"
#include <array>
#include "../qt/theme.h"
...
struct theme {
	QColor m_text_color;
	std::array<QColor, 4> m_icon_colors;
};
...
inline const QString font_awesome::name = ":/editor/font_awesome/fontawesome_4.7.0.ttf";

inline QIcon awesome(fa::icon icon, qt::theme::icon_colors colors = qt::current_theme.m_icon_colors) {
	static const auto font = font_factory::get<font_awesome>();
	return QIcon(new icon_font_engine(font, QChar(icon), colors));
}
}  // namespace ember::icon::awesome